...
(32 points) Consider applying PLSI to the following corpus (each line is a separate document):
ABAAC 
CABBC 
BABCBABC
...
Calculate the probability that each sentence (separately) is generated by the model specified by the vectors in (c) 
